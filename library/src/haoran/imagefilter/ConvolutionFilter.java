...
public class ConvolutionFilter implements IImageFilter {
    ...
    protected int GetPixelBrightness(Image input, int x, int y, int w, int h) {
        ...
        return ((((input.getRComponent(x, y) * 0x1b36) + (input.getGComponent(x, y) * 0x5b8c)) + (input
                .getBComponent(x, y) * 0x93e)) >> 15);
    }
    ...
    protected int GetPixelColor(Image input, int x, int y, int w, int h) {
        ...
        return (((255 << 24 | (input.getRComponent(x, y) << 16)) | (input.getGComponent(x, y) << 8)) | input
                .getBComponent(x, y));
    }
