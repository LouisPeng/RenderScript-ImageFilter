...
public class VideoFilter implements IImageFilter {
    ...
    public VideoFilter(int nVideoType) {
        ...
        switch (m_VideoType) {
            ...
            default: {
                this.pattern = new int[] {
                        0, 1, 2, 0, 0, 1, 1, 1, 2, 0, 0, 1, 2, 2, 2, 0, 0, 1, 2, 0, 0, 1, 1, 1, 2,
                        2, 0, 1, 2, 2, 0, 0, 0, 1, 2, 2, 0, 1, 1, 1, 2, 2, 0, 1, 2, 2, 0, 0, 0, 1,
                        1, 2, 0, 1, 1, 2, 2, 2, 0, 1, 1, 2, 0, 0, 0, 1, 1, 2, 0, 1, 1, 2, 2, 2, 0,
                };
                break;
            }
        }
    ...
    public Image process(Image imageIn) {
        int[] pattern_width = new int[] {
                2, 1, 3, 5
        };
        int[] pattern_height = new int[] {
                6, 3, 3, 15
        };
