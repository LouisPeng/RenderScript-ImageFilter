...
public class YCBCrLinearFilter implements IImageFilter {
    ...
    // / </summary>
    // /
    // / <remarks>The class encapsulates <b>YCbCr</b> color
    // components.</remarks>
    // /
    public static class YCbCr {
        ...
        // / <param name="ycbcr">Destination color in <b>YCbCr</b> color
        // space.</param>
        // /
        ...
        // / <param name="rgb">Source color in <b>RGB</b> color space.</param>
        // /
        // / <returns>Returns <see cref="YCbCr"/> instance, which represents
        // converted color value.</returns>
        // /
        ...
        // / </summary>
        // /
        // / <param name="ycbcr">Source color in <b>YCbCr</b> color
        // space.</param>
        // / <param name="rgb">Destination color in <b>RGB</b> color
        // spacs.</param>
        // /
        public static MyColor ToRGB(YCbCr ycbcr, MyColor rgb) {
            // don't warry about zeros. compiler will remove them
            float r = Math.max(0.0f,
                    Math.min(1.0f, (float)(ycbcr.Y + 0.0000 * ycbcr.Cb + 1.4022 * ycbcr.Cr)));
            float g = Math.max(0.0f,
                    Math.min(1.0f, (float)(ycbcr.Y - 0.3456 * ycbcr.Cb - 0.7145 * ycbcr.Cr)));
            float b = Math.max(0.0f,
                    Math.min(1.0f, (float)(ycbcr.Y + 1.7710 * ycbcr.Cb + 0.0000 * ycbcr.Cr)));
        ...
        // / </summary>
        // /
        // / <returns>Returns <see cref="RGB"/> instance, which represents
        // converted color value.</returns>
        // /
    ...
    public static class Range {
        ...
        // / <summary>
        // / Length of the range (deffirence between maximum and minimum
        // values).
        // / </summary>
        public float Length() {
            return Max - Min;
