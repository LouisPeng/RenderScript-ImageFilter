...
public class FocusFilter extends GaussianBlurFilter {
    ...
    public Image process(Image imageIn) {
        int ratio = imageIn.getWidth() > imageIn.getHeight() ? imageIn.getHeight() * 32768
                / imageIn.getWidth() : imageIn.getWidth() * 32768 / imageIn.getHeight();
            ...
            for (int j = 0; j < width; j++) {
                ...
                if (distSq > min) {
                    ...
                    imageIn.setPixelColor(j, i, (byte)(imageArray[pos] * 255f),
                            (byte)(imageArray[pos + 1] * 255f), (byte)(imageArray[pos + 2] * 255f));
                }
            }
        }
        return imageIn;
