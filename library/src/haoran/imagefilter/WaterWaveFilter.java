...
public class WaterWaveFilter extends RadialDistortionFilter {
    ...
    void DropStone(int x /* x��� */, int y /* y��� */, int stonesize /* ��Դ�뾶 */, int stoneweight /*
                                                                                                   * �
                                                                                                   * �
                                                                                                   * Դ
                                                                                                   * �
                                                                                                   ...
                                                                                                   * �
                                                                                                   */) {
        if ((x + stonesize) > width || (y + stonesize) > height || (x - stonesize) < 0
                || (y - stonesize) < 0) {
            return;
        }
    ...
    void render() {
        ...
        for (int i = 1; i < height - 1; i++) {
            for (int j = 0; j < width; j++) {
                ...
                // �����ƫ�����غ�ԭʼ���ص��ڴ��ַƫ����
                // image.setPixelColour(j, i, clone.getPixelColour(j+xoff,
                // i+yoff));
                int pos1, pos2;
