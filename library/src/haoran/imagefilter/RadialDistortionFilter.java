    ...
    public Image process(Image imageIn) {
        ...
        for (int x = 0; x < width; x++) {
            for (int y = 0; y < height; y++) {
                float pos = 1f - ((float)Math.sqrt(((x - realxpos) * (x - realxpos))
                        + (y - realypos) * (y - realypos)) / realradius);
                if (pos > 0f) {
                    ...
                    r = (int)((r * (1f - pos4) * (1f - pos3) + r2 * (1f - pos4) * pos3 + r3 * pos4
                            * pos3) + r4 * pos4 * (1f - pos3));
                    g = (int)((g * (1f - pos4) * (1f - pos3) + g2 * (1f - pos4) * pos3 + g3 * pos4
                            * pos3) + g4 * pos4 * (1f - pos3));
                    b = (int)((b * (1f - pos4) * (1f - pos3) + b2 * (1f - pos4) * pos3 + b3 * pos4
                            * pos3) + b4 * pos4 * (1f - pos3));
                } else {
